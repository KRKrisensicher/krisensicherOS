...
Dieser Standard gilt für alle krisensicherOS-Skills unter `skills/<skill-name>/SKILL.md`.
...
Verweis auf `07-ai-governance-agents/evals/quality-gates.md` und relevante artefaktspezifische Gates.
