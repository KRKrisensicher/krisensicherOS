...
krisensicherOS enthält fest verdrahtete öffentliche Referenzquellen unter [`../01-orientation/knowledge-sources/`](../../01-orientation/knowledge-sources/). Zusätzlich brauchen Organisationen Raum für eigene Vorgaben:
