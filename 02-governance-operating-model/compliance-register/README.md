...
krisensicherOS contains hard-wired public reference sources under [`../01-orientation/knowledge-sources/`](../../01-orientation/knowledge-sources/). In addition, organizations need space for their own requirements:
...
- [`../templates/compliance-source-register.md`](../../08-templates-playbooks/templates/compliance-source-register.md) — Markdown template for individual sources.
