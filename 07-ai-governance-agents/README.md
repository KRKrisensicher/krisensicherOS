...
- [`../docs/getting-started/eu-ai-act-readiness-start.md`](../00-start-here/docs/getting-started/eu-ai-act-readiness-start.md) — KI-Systeme als Inventar-, Vorprüfungs- und Handoff-Routine starten.
