...
Öffentliche Agentenprofile liegen in `07-ai-governance-agents/agents/public/*.md`. Lies das relevante Profil vollständig, bevor du ein Artefakt erstellst oder überarbeitest.

Das Manifest liegt in `07-ai-governance-agents/agents/manifest.yaml`.
