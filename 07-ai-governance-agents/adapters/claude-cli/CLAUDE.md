...
5. appropriate profile under `07-ai-governance-agents/agents/public/`
6. if needed, appropriate skill under `07-ai-governance-agents/skills/<skill>/SKILL.md`
7. `06-evidence-management-review/06-evidence-management-review/evals/quality-gates.md`
8. `02-governance-operating-model/governance/product-relevance-process.md` when files are created or changed
...
- New or changed files need a valid public product-relevance review note.
