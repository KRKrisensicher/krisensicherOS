...
This standard applies to all krisensicherOS skills under `07-ai-governance-agents/skills/<skill-name>/SKILL.md`.
...
Reference to `06-evidence-management-review/06-evidence-management-review/evals/quality-gates.md` and relevant artifact-specific gates.
