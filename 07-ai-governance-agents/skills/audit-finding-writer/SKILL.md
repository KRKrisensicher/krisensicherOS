...
version: 1.0.0
description: "Schreibt Audit-Findings aus Evidenz: Kriterium, Zustand, Wirkung, Ursache, Risiko, Maßnahme."
category: evidence
inputs:
  - scope
...
Dieser Skill hilft Nutzerorganisationen, Audit-Feststellungen und Abweichungen aus Evidenz sauber, nachvollziehbar und entscheidungsfähig zu formulieren.
...
Nutze den Skill, wenn interne Audits, Evidence Reviews oder Control Tests zu Feststellungen, Abweichungen oder Verbesserungsmaßnahmen führen.
...
- `07-ai-governance-agents/agents/public/audit-finding-reviewer.md`, sobald vorhanden,
...
- an `audit-finding-reviewer`, wenn fachliche Vertiefung nötig ist,
