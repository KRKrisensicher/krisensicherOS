...
version: 1.0.0
description: "Prüft Dokumente gegen Anforderungen und Register auf Lücken, Widersprüche, Alterung und Evidenzfähigkeit."
category: quality
inputs:
  - scope
...
Dieser Skill hilft Nutzerorganisationen, Dokumente gegen bestehende oder neue Anforderungen zu prüfen und Änderungsbedarf mit Ownern, Reviewpunkten und Freigabewegen abzuleiten.
...
Nutze den Skill, wenn neue Anforderungen, Normreferenzen, Policies, Kundenanforderungen oder interne Vorgaben gegen vorhandene Dokumente gemappt werden müssen.
...
- `07-ai-governance-agents/agents/public/document-gap-analyst.md`, sobald vorhanden,
...
- an `document-gap-analyst`, wenn fachliche Vertiefung nötig ist,
