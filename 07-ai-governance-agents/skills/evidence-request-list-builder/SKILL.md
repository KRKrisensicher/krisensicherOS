...
version: 1.0.0
description: "Erstellt Evidence Requests mit Ownern, Fristen, Qualitätskriterien, Evidenzziel und Human Gates."
category: evidence
inputs:
  - scope
...
Dieser Skill übersetzt Anforderungen, Auditfragen oder Prüfprogramme in eine konkrete Evidence Request List: Welche Nachweise werden benötigt, von wem, bis wann, in welcher Qualität und mit welchem Reviewpunkt.
...
Nutze den Skill, wenn ein internes Audit, Gap Assessment, Evidence Pack, Management Review oder Control Test vorbereitet wird und Nachweise strukturiert angefordert werden müssen.
...
Für einen fiktiven Zugriffskontrollprozess werden Policy-Auszug, Rollenmatrix, Freigabeprotokoll, Stichprobe und Review-Nachweis als getrennte Requests mit Owner und Qualitätskriterium angefordert.
