...
version: 1.0.0
description: "Erzeugt Board-Briefings aus Risiken, Evidenz, Optionen, Entscheidungen und nächsten Schritten."
category: management
inputs:
  - scope
  - existing-artifacts
...
Dieser Skill unterstützt Nutzerorganisationen dabei, erzeugt einen entscheidungsorientierten Board-/Management-Brief aus geprüften Risiken, Evidenz, Optionen und offenen Entscheidungen.
...
- Board Briefings, Managemententscheidungen oder Eskalationen aus Governance-Routinen,
...
- `08-templates-playbooks/templates/board-briefing-onepager.md`, sobald vorhanden,
...
- an `management-review-facilitator`, wenn fachliche Ausgestaltung vertieft werden muss,
