...
version: 1.0.0
description: "Prepare management reviews with agenda, decision questions, options, risks, and follow-up."
category: management
inputs:
  - scope
  - existing-artifacts
...
This skill helps user organizations prepare management reviews with agenda, decision questions, options, risks, measures, and follow-up.
...
- management reviews, escalations, prioritization decisions, or resource questions,
...
- `08-templates-playbooks/templates/management-review-agenda.md`, once available,
...
- to `management-review-facilitator` if subject-matter design needs to be deepened,
- to `control-evidence-architect` if evidence flows need to be specified,
