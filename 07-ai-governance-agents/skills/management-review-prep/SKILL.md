...
version: 1.0.0
description: "Bereitet Management Reviews mit Agenda, Entscheidungsfragen, Optionen, Risiken und Follow-up vor."
category: management
inputs:
  - scope
  - existing-artifacts
...
Dieser Skill unterstützt Nutzerorganisationen dabei, bereitet Management Reviews mit Agenda, Entscheidungsfragen, Optionen, Risiken, Maßnahmen und Follow-up vor.
...
- Management Reviews, Eskalationen, Priorisierungsentscheidungen oder Ressourcenfragen,
...
- `08-templates-playbooks/templates/management-review-agenda.md`, sobald vorhanden,
