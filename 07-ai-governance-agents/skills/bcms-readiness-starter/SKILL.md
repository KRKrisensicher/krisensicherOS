...
version: 1.0.0
description: "Startet BCMS-Readiness über kritische Prozesse, Abhängigkeiten, Impact, Wiederanlauf und Evidenz."
category: bcms
inputs:
  - scope
  - existing-artifacts
...
Dieser Skill unterstützt Nutzerorganisationen dabei, startet BCMS-Readiness mit kritischen Prozessen, Abhängigkeiten, Impact-Annahmen, Wiederanlauf-Routinen, Evidenz und Managemententscheidungen.
...
- BCMS-Readiness, kritische Prozesse, Wiederanlaufplanung oder Resilienz-Reviews,
...
- an `bcms-readiness-designer`, wenn fachliche Ausgestaltung vertieft werden muss,
