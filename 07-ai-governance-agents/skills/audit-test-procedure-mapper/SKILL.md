...
version: 1.0.0
description: "Mappt Auditfragen auf Prüfmethoden, Stichproben, Evidenzarten, Bewertung und Eskalation."
category: evidence
inputs:
  - scope
...
Dieser Skill hilft Nutzerorganisationen, aus Anforderungen und Auditfragen ein prüfbares Auditprogramm mit Methoden, Stichprobenansatz, Evidenzarten und Bewertungshinweisen zu erzeugen.
...
Nutze den Skill, wenn aus Fragebögen konkrete Prüfungshandlungen, Interviews, Dokumentenprüfungen, Beobachtungen oder Stichproben abgeleitet werden müssen.
