...
Alle Skills folgen [`docs/standards/skill-standard-v1.0.md`](../../10-reference/docs/standards/skill-standard-v1.0.md).
...
Alle Skills müssen gegen [`07-ai-governance-agents/evals/quality-gates.md`](../evals/quality-gates.md) geprüft werden.
