...
version: 1.0.0
description: "Erstellt Audit-Fragebögen aus Anforderungen, Quellen, Mappings, Leitfragen und Evidenzzielen."
category: evidence
inputs:
  - scope
...
Dieser Skill hilft Nutzerorganisationen, interne Audit-Fragebögen aus Anforderungen abzuleiten und so zu strukturieren, dass Prüfer mit Leitfragen, Kriterien, Evidenzzielen und Human Gates arbeiten können.
...
Nutze den Skill, wenn interne Audits, Self-Assessments, Lieferantenreviews oder Managementsystem-Reviews vorbereitet werden.
...
- `08-templates-playbooks/templates/audit-questionnaire.md`,
...
- an `internal-audit-planner`, wenn fachliche Vertiefung nötig ist,
