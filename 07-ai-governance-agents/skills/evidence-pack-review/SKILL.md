...
version: 1.0.0
description: "Review evidence packs for currency, traceability, gaps, assumptions, and decision readiness."
category: evidence
inputs:
  - scope
  - existing-artifacts
...
This skill supports user organizations in reviewing evidence packs for completeness, currency, traceability, gaps, assumptions, and decision readiness.
...
- evidence pack review, measure closure, audit preparation, or management review,
...
- Has unnecessary documentation workload been removed?
...
- to `evidence-pack-reviewer` when domain-specific elaboration needs to be deepened,
- to `control-evidence-architect` when evidence flows need to be made concrete,
