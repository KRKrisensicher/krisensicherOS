...
version: 1.0.0
description: "Prüft Evidence Packs auf Aktualität, Traceability, Lücken, Annahmen und Entscheidungsreife."
category: evidence
inputs:
  - scope
  - existing-artifacts
...
Dieser Skill unterstützt Nutzerorganisationen dabei, prüft Evidence Packs auf Vollständigkeit, Aktualität, Traceability, Lücken, Annahmen und Entscheidungsfähigkeit.
...
- Evidence-Pack-Review, Maßnahmenabschluss, Audit-Vorbereitung oder Management Review,
...
- an `evidence-pack-reviewer`, wenn fachliche Ausgestaltung vertieft werden muss,
