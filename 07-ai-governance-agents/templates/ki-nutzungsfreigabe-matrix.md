...
Wenn `lokale KI` oder ein lokales Redaction-Tool gewählt wird, muss zusätzlich `01-orientation/setup/lokale-ki.md` geprüft werden. Dort werden Modell-/Checkpoint-Freigabe, Windows-Pilot, Speicherorte, Logging, Netzwerkbindung, Teamnutzung, Evaluation und Offboarding geklärt. Die zusammenfassende Übersicht liegt ergänzend in `01-orientation/setup/ki-setups-bedienungsanleitung.md`.
