...
Nutze dieselben Pfade zunächst über Templates, Playbooks und Leitfäden. Beginne bei [`../../01-orientation/getting-started/anwenderpfade.md`](../../../01-orientation/getting-started/anwenderpfade.md) und öffne nur die Artefakte aus „Pflicht in 15 Minuten“. Agenten beschleunigen Strukturierung und Review, ersetzen aber keine interne Verantwortung.
