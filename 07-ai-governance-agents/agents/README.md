...
Die öffentlichen Nutzeragenten liegen unter [`agents/public/`](public/). Sie bilden ein Rollenmodell für Organisationen, die mit krisensicherOS ein eigenes Compliance- und Security-Governance-Agentensystem aufbauen wollen.
...
Für den Einstieg mit wenigen Rollen siehe [`agents/public/anwender-routing.md`](public/anwender-routing.md). Das vollständige Rollenmodell steht in [`07-ai-governance-agents/agents/public/role-model.md`](public/role-model.md) und das Routingmanifest in [`agents/manifest.yaml`](manifest.yaml).
