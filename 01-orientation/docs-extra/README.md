...
2. [`getting-started/README.md`](../../README.md) — navigation through the entry paths.
...
5. [`setup/README.md`](../../README.md) — selection of an approved AI environment.
...
7. [`product/was-wir-bewusst-nicht-bauen.md`](../product-positioning/was-wir-bewusst-nicht-bauen.md) — product guardrail against feature creep, apparent compliance, and template volume.
...
If there is no AI usage approval yet, krisensicherOS is not yet operational. In that case, use only [`../templates/ki-nutzungsfreigabe-matrix.md`](../../07-ai-governance-agents/templates/ki-nutzungsfreigabe-matrix.md) to prepare the approval.

## Readiness

NIS2 readiness artifacts:

- [`readiness/nis2-erwaegungsgruende-implementierungslogik.md`](../../03-nis2-readiness/readiness/nis2-erwaegungsgruende-implementierungslogik.md) — recitals of the NIS2 Directive as implementation logic.
