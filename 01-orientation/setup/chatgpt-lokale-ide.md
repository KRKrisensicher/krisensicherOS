...
Without a completed [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../07-ai-governance-agents/templates/ki-nutzungsfreigabe-matrix.md) **and** without the following ChatGPT-specific check table, this path is not used. In that case, only the approval is prepared; productive use stops.
