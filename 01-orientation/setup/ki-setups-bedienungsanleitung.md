...
3. **Projektkontext lesen lassen**
   ...
   ```text
   Lies README.md, AGENTS.md, 02-governance-operating-model/governance/review-process.md und 06-evidence-management-review/06-evidence-management-review/evals/quality-gates.md.
...
4. **Änderungen immer mit Plan und Diff**
   ...
   Regeln:
   - Folge templates/README.md und 06-evidence-management-review/06-evidence-management-review/evals/quality-gates.md.
...
- neue Skills unter `07-ai-governance-agents/skills/<name>/SKILL.md`,
- Templates ergänzen,
