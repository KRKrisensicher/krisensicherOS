...
- Für erlaubte KI-Umgebungen: [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../07-ai-governance-agents/templates/ki-nutzungsfreigabe-matrix.md)
- Für Governance-Entscheidungen: [`../../templates/decision-log.md`](../../02-governance-operating-model/templates/decision-log.md)
- Für rechtliche oder datenschutzrechtliche Fragen: [`../../templates/legal-datenschutz-handoff.md`](../../02-governance-operating-model/templates/legal-datenschutz-handoff.md)
- Für Ablaufsteuerung: [`../../workflows/eu-ai-act-readiness-precheck.yaml`](../../07-ai-governance-agents/workflows/eu-ai-act-readiness-precheck.yaml)
