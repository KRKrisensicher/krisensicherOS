...
2. Select `01-orientation/setup/ki-setups-bedienungsanleitung.md`: ChatGPT, M365 Copilot, Claude Code, or local AI.
3. Read `07-ai-governance-agents/agents/public/role-model.md` and choose a suitable role:
