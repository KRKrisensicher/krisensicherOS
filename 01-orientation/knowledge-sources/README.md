...
- [`../02-governance-operating-model/compliance-register/README.md`](../../02-governance-operating-model/compliance-register/README.md) — Anleitung für nutzereigene Compliance-Register.
- [`legal-boundaries/iso-normen-lizenzkonform-nutzen.md`](../legal-boundaries/iso-normen-lizenzkonform-nutzen.md) — Hinweise zur lizenzkonformen Nutzung von ISO-Normen.
