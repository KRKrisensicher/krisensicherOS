...
- [`../02-governance-operating-model/compliance-register/README.md`](../../02-governance-operating-model/compliance-register/README.md) — guidance for user-owned compliance registers.
- [`legal-boundaries/iso-normen-lizenzkonform-nutzen.md`](../legal-boundaries/iso-normen-lizenzkonform-nutzen.md) — notes on using ISO standards in a license-compliant way.
