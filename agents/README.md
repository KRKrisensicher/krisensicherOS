...
Für den Einstieg mit wenigen Rollen siehe [`agents/public/anwender-routing.md`](public/anwender-routing.md). Das vollständige Rollenmodell steht in [`agents/public/role-model.md`](public/role-model.md) und das Routingmanifest in [`agents/manifest.yaml`](manifest.yaml).
