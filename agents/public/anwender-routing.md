...
Use the same paths first via templates, playbooks, and guides. Start at [`../../docs/getting-started/anwenderpfade.md`](../../docs/getting-started/anwenderpfade.md) and open only the artifacts from “Required in 15 minutes”. Agents accelerate structuring and review, but do not replace internal responsibility.
