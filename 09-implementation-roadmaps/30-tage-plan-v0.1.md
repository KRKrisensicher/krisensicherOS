...
- Prioritize first template/playbook list

**Result:** Orientation, scope, and quality standard are in place.

## Week 2 — Governance Operating Model and NIS2 Readiness

**Goal:** Make first operational core modules usable.
...
**Result:** Agents and skills are usable as repeatable workflows.

## Week 4 — Playbooks, Examples, Release Hardening

**Goal:** Make v0.1 ready for publication.
...
- Each core module has purpose, operating logic, and first artifacts.
- Each template answers: Who uses it, when, for what purpose, with which decision?
- No template promises legal or certification certainty.
- Agent roles have clear boundaries.
- Skills are described as workflows.
- README explains the category “agentic security governance” clearly.
- A new user can understand in less than 30 minutes how to start with krisensicherOS.
