...
Für Einzelrisiken oder kleine Workshops kann der Risikoprozess als geführter Wizard durchgeführt werden. Der Wizard nutzt den Skill [`isms-risk-analysis`](../skills/isms-risk-analysis/SKILL.md) und hält den Stand in [`templates/risikoanalyse-session-state.md`](../templates/risikoanalyse-session-state.md) fest.
