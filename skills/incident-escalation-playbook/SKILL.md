...
version: 1.0.0
description: "Entwirft Incident-Eskalation mit Triggern, Rollen, Kommunikation, Entscheidungen und Nachbereitung."
category: incident
inputs:
  - scope
  - existing-artifacts
...
Dieser Skill unterstützt Nutzerorganisationen dabei, entwirft Incident-Eskalationslogik mit Triggern, Rollen, Kommunikationspunkten, Entscheidungen und Nachbereitung.
...
- Incident Readiness, Eskalationsdesign oder Erstbewertung ohne Live-Krisenleitung,
...
- `agents/public/incident-readiness-coach.md`,
...
- `templates/incident-escalation-card.md`, sobald vorhanden,
