...
Alle Skills folgen [`docs/standards/skill-standard-v1.0.md`](../docs/standards/skill-standard-v1.0.md).
...
Alle Skills müssen gegen [`evals/quality-gates.md`](../evals/quality-gates.md) geprüft werden.
