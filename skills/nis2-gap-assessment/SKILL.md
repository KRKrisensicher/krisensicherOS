...
- **Source references:** public reference anchors from `knowledge/` or own register entries without reproducing full licensed content.
...
- `compliance-register/sources.example.yaml` or an own register,
