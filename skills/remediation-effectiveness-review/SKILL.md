...
version: 1.0.0
description: "Prüft Maßnahmen auf Umsetzungsnachweis, Wirksamkeit, Restrisiko, Reopen-Bedarf und Handoff."
category: evidence
inputs:
  - scope
...
Dieser Skill verhindert, dass Maßnahmen nur geschlossen werden, weil eine Aufgabe erledigt wirkt. Er prüft Nachweis, Wirksamkeit, Restrisiko und ob ein Finding wirklich geschlossen werden kann.
...
Nutze den Skill, wenn Corrective Actions, Auditmaßnahmen, Gaps oder Management-Review-Maßnahmen als erledigt gemeldet wurden und eine Wirksamkeitsprüfung nötig ist.
...
Eine fiktive Maßnahme zur Rollenmatrix wird nicht automatisch geschlossen; geprüft werden neuer Prozess, Stichprobe, Owner-Bestätigung, Reviewtermin und Restrisiko.
