...
Use only approved SharePoint libraries with `repo-scope: product` artifacts.
...
3. suggest a suitable role from `agents/public/role-model.md`,
...
Recommended role:
- <Agent role from agents/public/role-model.md>
