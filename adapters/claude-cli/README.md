...
- `agents/public/*.md` — public agent roles,
- `agents/manifest.yaml` — role/routing manifest,
- `skills/*/SKILL.md` — repeatable skills,
- `evals/quality-gates.md` — quality and safety gates.
...
Read AGENTS.md, CLAUDE.md, README.md, agents/manifest.yaml, and evals/quality-gates.md.
...
| Check agents/subagents | `/agents` | Domain logic remains in `agents/public/*.md`, not only in Claude configuration. |
...
2. Select a suitable role from `agents/public/role-model.md`.
3. Read the relevant profile fully.
4. For a repeatable task, read the suitable skill from `skills/`.
5. Create a plan.
...
First read AGENTS.md, CLAUDE.md, agents/public/role-model.md, and the suitable profile under agents/public/.
If a skill fits, also read skills/<skill>/SKILL.md.
