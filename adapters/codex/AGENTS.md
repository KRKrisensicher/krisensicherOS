...
Public agent profiles are located in `agents/public/*.md`. Read the relevant profile in full before creating or revising an artifact.

The manifest is located in `agents/manifest.yaml`.
