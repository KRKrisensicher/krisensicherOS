...
Lies README.md, AGENTS.md, CLAUDE.md, docs/setup/README.md und evals/quality-gates.md.
...
Regeln:
- Folge AGENTS.md, CLAUDE.md und evals/quality-gates.md.
...
- Templates schärfen,
- Skills unter `skills/<name>/SKILL.md` erstellen,
