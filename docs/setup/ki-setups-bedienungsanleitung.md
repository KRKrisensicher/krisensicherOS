...
3. **Have project context read**
   ...
   ```text
   Read README.md, AGENTS.md, governance/review-process.md, and evals/quality-gates.md.
...
4. **Always make changes with plan and diff**
   ...
   Rules:
   - Follow templates/README.md and evals/quality-gates.md.
...
- private knowledge/document questions,
- low entry barrier.
...
- Git
- local checks
- work via skills/templates/workflows
