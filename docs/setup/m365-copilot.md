...
Vor Upload in SharePoint muss je Artefakt oder Artefaktgruppe die [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../templates/ki-nutzungsfreigabe-matrix.md) oder eine gleichwertige interne Regel geklärt sein.
...
9. Entscheidung, Annahme, Lücke oder Handoff in [`../../templates/decision-log.md`](../../templates/decision-log.md) oder Review-Notiz übertragen.
