...
Before uploading to SharePoint, the [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../templates/ki-nutzungsfreigabe-matrix.md) or an equivalent internal rule must be clarified for each artifact or artifact group.
...
9. Transfer decision, assumption, gap, or handoff to [`../../templates/decision-log.md`](../../templates/decision-log.md) or a review note.
