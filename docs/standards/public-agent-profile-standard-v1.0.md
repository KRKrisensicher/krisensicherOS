...
Dieser Standard gilt für alle öffentlichen Zielrepo-Agenten unter `agents/public/`.
...
Jedes Profil in `agents/public/*.md` muss in `agents/manifest.yaml` referenziert sein.
