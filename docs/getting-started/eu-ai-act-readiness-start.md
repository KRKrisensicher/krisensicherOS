...
1. [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../templates/ki-nutzungsfreigabe-matrix.md)
2. [`../../templates/ki-system-inventar-und-risikovorpruefung.md`](../../templates/ki-system-inventar-und-risikovorpruefung.md)
...
- Für erlaubte KI-Umgebungen: [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../templates/ki-nutzungsfreigabe-matrix.md)
- Für Governance-Entscheidungen: [`../../templates/decision-log.md`](../../templates/decision-log.md)
- Für rechtliche oder datenschutzrechtliche Fragen: [`../../templates/legal-datenschutz-handoff.md`](../../templates/legal-datenschutz-handoff.md)
- Für Ablaufsteuerung: [`../../workflows/eu-ai-act-readiness-precheck.yaml`](../../workflows/eu-ai-act-readiness-precheck.yaml)
