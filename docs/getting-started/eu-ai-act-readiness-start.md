...
- For approved AI environments: [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../templates/ki-nutzungsfreigabe-matrix.md)
- For governance decisions: [`../../templates/decision-log.md`](../../templates/decision-log.md)
- For legal or data protection questions: [`../../templates/legal-datenschutz-handoff.md`](../../templates/legal-datenschutz-handoff.md)
- For workflow control: [`../../workflows/eu-ai-act-readiness-precheck.yaml`](../../workflows/eu-ai-act-readiness-precheck.yaml)
