...
Vor jedem Pfad: KI-Freigabe, Datenklasse, erlaubte Umgebung und Human Gates prüfen. Wenn keine Freigabe vorliegt, nur die Freigabe mit [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../templates/ki-nutzungsfreigabe-matrix.md) vorbereiten.
...
**Nächster Schritt:** Evidence Requests mit Ownern klären oder in [`../../workflows/evidence-management-review.yaml`](../../workflows/evidence-management-review.yaml) überführen.
...
**Nächster Schritt:** Beispiel [`../../examples/fiktiver-mittelstand/isms-90-minuten-durchstich.md`](../../examples/fiktiver-mittelstand/isms-90-minuten-durchstich.md) als Muster nutzen und eigene Artefakte in Templates übertragen.
...
**Nächster Schritt:** Monatliche Routine mit [`../../playbooks/monthly-security-governance-review.md`](../../playbooks/monthly-security-governance-review.md) starten.
