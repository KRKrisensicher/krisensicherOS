...
Ohne ausgefüllte [`../../templates/ki-nutzungsfreigabe-matrix.md`](../../../08-templates-playbooks/templates/ki-nutzungsfreigabe-matrix.md) **und** ohne die folgende ChatGPT-spezifische Prüftabelle wird dieser Pfad nicht genutzt. Dann wird nur die Freigabe vorbereitet; produktive Nutzung stoppt.
