...
- [`../../templates/rollenmatrix.md`](../../../08-templates-playbooks/templates/rollenmatrix.md)
...
- [`../../playbooks/monthly-security-governance-review.md`](../../../08-templates-playbooks/playbooks/monthly-security-governance-review.md)
...
**Template:** [`../../templates/decision-log.md`](../../../08-templates-playbooks/templates/decision-log.md)
...
**Template:** [`../../templates/evidence-pack-index.md`](../../../08-templates-playbooks/templates/evidence-pack-index.md)
...
- [`../../implementierungsleitfaeden/isms/09-monitoring-management-review-und-entscheidungen.md`](../../../04-isms-basics/implementation-guides/09-monitoring-management-review-und-entscheidungen.md)
