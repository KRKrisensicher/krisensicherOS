...
- Adapter navigation added under `adapters/`.
...
- Public agent profiles under `agents/public/`.
...
- Fixed public reference source structure under `knowledge/`.
- Compliance register structure under `compliance-register/`.
...
- Product guardrail `docs/product/was-wir-bewusst-nicht-bauen.md` added: no false compliance, no standard text replication, no template overload, and no AI magic without human gates.
